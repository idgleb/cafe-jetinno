<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="/novedades" :active="request()->is('novedades')">
                        Novedades
                    </x-nav-link>
                    @auth
                        <x-nav-link href="/admin/novedades" :active="request()->is('admin/novedades*')">
                            Admin Novedades
                        </x-nav-link>
                    @endauth
                    @guest
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <!-- Agregá aquí -->
            <x-responsive-nav-link href="/productos" :active="request()->is('productos')">
                Productos
            </x-responsive-nav-link>
            <x-responsive-nav-link href="/novedades" :active="request()->is('novedades')">
                Novedades
            </x-responsive-nav-link>
            @auth
                <x-responsive-nav-link href="/admin/novedades" :active="request()->is('admin/novedades*')">
                    Admin Novedades
                </x-responsive-nav-link>
            @endauth
            @guest
